...
public class EventoController {
    ...
    public ResponseEntity<?> readById(@PathVariable Long id) {
        ...
        if (evento == null) {
            respuesta.put("mensaje",
                    "El evento con ID: ".concat(id.toString().concat(" no existe en la base de datos")));
    ...
    public ResponseEntity<?> update(@RequestBody Evento evento, @PathVariable Long id) {
        ...
        if (e == null) {
            respuesta.put("mensaje",
                    "Error: no se pudo editar el evento con ID: ".concat(id.toString().concat("no existe en la bd")));
            return new ResponseEntity<Map<String, Object>>(respuesta, HttpStatus.NOT_FOUND);
        }
        try {
    ...
    public ResponseEntity<?> delete(@PathVariable Long id) {
        ...
        if (e == null) {
            respuesta.put("mensaje",
                    "Error: no se pudo eliminar el evento con ID: ".concat(id.toString().concat("no existe en la bd")));
            return new ResponseEntity<Map<String, Object>>(respuesta, HttpStatus.NOT_FOUND);
        }
        try {
